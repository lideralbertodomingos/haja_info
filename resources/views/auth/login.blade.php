    ...
    <div class="login-wrapper ">
        ...
        <div class="bg-pic">
            ...
            <div class="bg-caption pull-bottom sm-pull-bottom text-white p-l-20 m-b-20">
                <h1 class="semi-bold text-white">
                    Haja Inf - Continuar com sessão</h1>
                <p class="small">
        ...
        <div class="login-container bg-white">
            <div class="p-l-50 p-r-50 p-t-50 m-t-30 sm-p-l-15 sm-p-r-15 sm-p-t-40">
                <img src="{{ asset('admin/assets/img/logo-48x48_c.png') }}" alt="logo"
                    data-src="{{ asset('admin/assets/img/logo-48x48_c.png') }}"
                    data-src-retina="{{ asset('admin/assets/img/logo-48x48_c@2x.png') }}" width="48"
                    height="48">
                <h2 class="p-t-25">Continuar com login <br /> Para melhor experiência</h2>
                <!-- START Login Form -->
                <form method="POST" action="{{ route('login') }}" id="form-login" class="p-t-15" role="form">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 d-flex align-items-center justify-content-end">
                            <button aria-label="" class="btn btn-primary btn-lg m-t-10" type="submit">
                                Iniciar Login
                            </button>
                        </div>
                    </div>
                    <div class="m-b-5 m-t-30">
                        <a href="#" class="normal">Esqueceu a Senha?</a>
                    </div>
                    <div>
                        Ainda sem conta?<a href="{{ route('register') }}" class="normal"> Criar agora.</a>
                    </div>
                    <!-- END Form Control-->
                </form>
                <!--END Login Form-->
                    ...
                    <div class="m-b-30 p-r-80 sm-m-t-20 sm-p-r-15 sm-p-b-20 clearfix">
                        <div class="col-sm-9 no-padding m-t-10">
                            <p class="small-text normal hint-text">
                                © {{ date('Y') }} Todos os Direitos Reservados.<a
                                    href="{{ route('home.index') }}">Haja Inf</a>.
                            </p>
                        </div>
                    </div>
                </div>
    ...
    <div class="overlay hide" data-pages="search">
        ...
        <div class="overlay-content has-results m-t-20">
            ...
            <div class="container-fluid">
                <!-- BEGIN Overlay Logo !-->
                <img class="overlay-brand" src="{{ asset('admin/assets/img/logo.png') }}" alt="logo"
                            ...
                            <div class="d-flex m-t-15">
                                ...
                                <div class="thumbnail-wrapper d48 circular bg-success text-white ">
                                    <img width="36" height="36"
                                        src="{{ asset('admin/assets/img/profiles/avatar.jpg') }}"
                                        data-src="{{ asset('admin/assets/img/profiles/avatar.jpg') }}"
                                        data-src-retina="{{ asset('admin/assets/img/profiles/avatar2x.jpg') }}"
                                        alt="">
                                </div>
