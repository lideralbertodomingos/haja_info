              ...
              <div class="list-view-group-container">
                ...
                <ul>
                  ...
                  <li class="chat-user-list clearfix">
                    <a data-view-animation="push-parrallax" data-view-port="#chat" data-navigate="view" class="" href="#">
                      <span class="thumbnail-wrapper d32 circular bg-success">
                          <img width="34" height="34" alt="" data-src-retina="{{ asset('admin/assets/img/profiles/2x.jpg')  }}" data-src="{{ asset('admin/assets/img/profiles/2.jpg')  }}" src="{{ asset('admin/assets/img/profiles/2x.jpg')  }}" class="col-top">
                      </span>
                      <p class="p-l-10 ">
              ...
              <div class="list-view-group-container">
                ...
                <ul>
                  ...
                  <li class="chat-user-list clearfix">
                    <a data-view-animation="push-parrallax" data-view-port="#chat" data-navigate="view" class="" href="#">
                      <span class="thumbnail-wrapper d32 circular bg-success">
                          <img width="34" height="34" alt="" data-src-retina="{{ asset('admin/assets/img/profiles/4x.jpg')  }}" data-src="{{ asset('admin/assets/img/profiles/4.jpg')  }}" src="{{ asset('admin/assets/img/profiles/4x.jpg')  }}" class="col-top">
                      </span>
                      <p class="p-l-10 ">
                  ...
                  <li class="chat-user-list clearfix">
                    <a data-view-animation="push-parrallax" data-view-port="#chat" data-navigate="view" class="" href="#">
                      <span class="thumbnail-wrapper d32 circular bg-success">
                          <img width="34" height="34" alt="" data-src-retina="{{ asset('admin/assets/img/profiles/5x.jpg')  }}" data-src="{{ asset('admin/assets/img/profiles/5.jpg')  }}" src="{{ asset('admin/assets/img/profiles/5x.jpg')  }}" class="col-top">
                      </span>
                      <p class="p-l-10 ">
              ...
              <div class="list-view-group-container">
                ...
                <ul>
                  ...
                  <li class="chat-user-list clearfix">
                    <a data-view-animation="push-parrallax" data-view-port="#chat" data-navigate="view" class="" href="#">
                      <span class="thumbnail-wrapper d32 circular bg-success">
                          <img width="34" height="34" alt="" data-src-retina="{{ asset('admin/assets/img/profiles/6x.jpg')  }}" data-src="{{ asset('admin/assets/img/profiles/6.jpg')  }}" src="{{ asset('admin/assets/img/profiles/6x.jpg')  }}" class="col-top">
                      </span>
                      <p class="p-l-10 ">
                  ...
                  <li class="chat-user-list clearfix">
                    <a data-view-animation="push-parrallax" data-view-port="#chat" data-navigate="view" class="" href="#">
                      <span class="thumbnail-wrapper d32 circular bg-success">
                          <img width="34" height="34" alt="" data-src-retina="{{ asset('admin/assets/img/profiles/7x.jpg')  }}" data-src="{{ asset('admin/assets/img/profiles/7.jpg')  }}" src="{{ asset('admin/assets/img/profiles/7x.jpg')  }}" class="col-top">
                      </span>
                      <p class="p-l-10 ">
              ...
              <div class="list-view-group-container">
                ...
                <ul>
                  ...
                  <li class="chat-user-list clearfix">
                    <a data-view-animation="push-parrallax" data-view-port="#chat" data-navigate="view" class="" href="#">
                      <span class="thumbnail-wrapper d32 circular bg-success">
                          <img width="34" height="34" alt="" data-src-retina="{{ asset('admin/assets/img/profiles/8x.jpg')  }}" data-src="{{ asset('admin/assets/img/profiles/8.jpg')  }}" src="{{ asset('admin/assets/img/profiles/8x.jpg')  }}" class="col-top">
                      </span>
                      <p class="p-l-10 ">
                  ...
                  <li class="chat-user-list clearfix">
                    <a data-view-animation="push-parrallax" data-view-port="#chat" data-navigate="view" class="" href="#">
                      <span class="thumbnail-wrapper d32 circular bg-success">
                          <img width="34" height="34" alt="" data-src-retina="{{ asset('admin/assets/img/profiles/9x.jpg')  }}" data-src="{{ asset('admin/assets/img/profiles/9.jpg')  }}" src="{{ asset('admin/assets/img/profiles/9x.jpg')  }}" class="col-top">
                      </span>
                      <p class="p-l-10 ">
            ...
            <div class="col-md-6">
              ...
              <div class="d-flex m-t-15">
                ...
                <div class="thumbnail-wrapper d48 circular bg-success text-white ">
                  <img width="36" height="36" src="{{ asset('admin/assets/img/profiles/avatar.jpg')  }}" data-src="{{ asset('admin/assets/img/profiles/avatar.jpg')  }}" data-src-retina="{{ asset('admin/assets/img/profiles/avatar2x.jpg')  }}" alt="">
                </div>
