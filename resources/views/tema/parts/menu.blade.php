                                    ...
                                    <div class="heading">
                                        <div
                                            ...
                                            <img width="30" height="30"
                                                data-src-retina="{{ asset('admin/assets/img/profiles/1x.jpg') }}"
                                                data-src="{{ asset('admin/assets/img/profiles/1.jpg') }}" alt=""
                                                src="{{ asset('admin/assets/img/profiles/1.jpg') }}">
                                        </div>
            ...
            <button class="profile-dropdown-toggle" type="button" data-toggle="dropdown" aria-haspopup="true"
                ...
                <span class="thumbnail-wrapper d32 circular inline">
                    <img src="{{ asset('admin/assets/img/profiles/avatar.jpg') }}" alt=""
                        ...
                        data-src-retina="{{ asset('admin/assets/img/profiles/avatar_small2x.jpg') }}" width="32"
                        height="32">
                </span>
            </button>
            <div class="dropdown-menu dropdown-menu-right profile-dropdown" role="menu">
                ...
                <form action="{{ route('logout') }}" method="post">
                    ...
                    <button type="submit" class="btn">
                        <a class="dropdown-item">Terminar Sessão</a>
                    </button>
                </form>
                <div class="dropdown-divider"></div>
